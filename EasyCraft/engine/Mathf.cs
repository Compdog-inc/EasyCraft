...
namespace EasyCraft.engine
{
    public static class Mathf
    {
        ...
        {
            return perlin(x, 0.1f, 0.1f);
        }

        public static float PerlinNoise(float x, float y)
        {
            return perlin(x, y, 0.1f);
        }

        public static Vector2 GetVector2FromIndex(int index, int width)
        {
            return new Vector2(index % width, index / width);
        }

        public static Vector3 GetVector3FromIndex(int index, int width, int height)
        {
            int x = index % width;
            ...
            index /= height;
            return new Vector3(x, y, index);
        }

        public static int GetIndexFromVector2(Vector2 pos, int width)
        {
            if (pos.X < 0)
            {
            ...
            return FloorToInt(pos.X + pos.Y * width);
        }
